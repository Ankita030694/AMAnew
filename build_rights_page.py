...
page_path = "src/app/what-are-my-legal-rights-when-dealing-with-recovery-agents/page.tsx"

# The Lead Hook verbatim:
lead_hook = "Under the Reserve Bank of India’s strict Fair Practices Code, recovery agents are legally prohibited from calling borrowers outside the hours of 8:00 AM to 7:00 PM or visiting their workplace without prior consent. Despite these clear regulations, thousands of Indian borrowers face daily intimidation, verbal abuse, and illegal public shaming from third-party debt collectors operating outside the bounds of law."

faqs = [
    {
        "question": "Can recovery agents enter my house legally?",
        "answer": "No, recovery agents cannot enter your house legally without your explicit permission. Under the RBI's Fair Practices Code and constitutional rights, forceful entry constitutes criminal trespass. Agents must only visit your residence if you have mutually agreed to a meeting for debt collection purposes."
    },
    {
        "question": "Is it legal for recovery agents to contact my employer?",
        "answer": "No, it is strictly illegal for recovery agents to contact your employer or colleagues regarding your personal debts. Debt collection must remain confidential. Discussing your financial liabilities with third parties violates RBI guidelines and constitutes social shaming, which is actionable under defamation laws."
    },
    {
        "question": "What should I do if a recovery agent abuses me verbally?",
        "answer": "If a recovery agent abuses you verbally, immediately start recording the call or interaction. Do not engage in an argument. Terminate the conversation, save the evidence, and file a formal grievance with the bank's nodal officer and a criminal intimidation complaint at the local police station."
    },
    {
        "question": "Can I stop paying my EMI if I am harassed?",
        "answer": "While harassment is illegal, it does not extinguish your contractual obligation to repay the loan. You are still legally bound to clear your dues. However, you can file a complaint with the RBI Ombudsman to stop the harassment and negotiate a formal loan settlement plan."
    },
    {
        "question": "Are banks liable for the actions of third-party recovery agents?",
        "answer": "Yes, banks are absolutely liable for the actions of their appointed third-party recovery agents. The RBI strictly mandates that lending institutions must conduct due diligence and are directly responsible if their empanelled agents violate the Fair Practices Code or resort to coercive recovery methods."
    },
    {
        "question": "How do I file an RBI Ombudsman complaint?",
        "answer": "You can file an RBI Ombudsman complaint online through the CMS (Complaint Management System) portal on the RBI website. You must first complain to the bank's grievance redressal officer; if they do not resolve the issue within thirty days, you can escalate it to the Ombudsman."
    },
    {
        "question": "Can recovery agents seize my car without a court order?",
        "answer": "Yes, for secured vehicle loans, banks can repossess your car without a court order if you default, but they must follow due process. They must issue a prior notice before repossession. However, the repossession process cannot involve physical force, violence, or criminal intimidation."
    }
]
...
reviews = [
    {
        "name": "Saurabh Mishra",
        "rating": "5",
        "text": "I was receiving fifty calls a day from abusive recovery agents who threatened my family. AMA Legal Solutions guided me to file a police complaint and an RBI grievance. The harassment stopped within forty-eight hours, and they helped me secure a legal settlement."
    },
    {
        "name": "Neha Gupta",
        "rating": "5",
        "text": "When recovery agents showed up at my office to publicly shame me, I was terrified. Advocate Anuj Anand Malik immediately sent a legal notice to the bank's headquarters. The bank recalled the agents instantly, proving that knowing your legal rights actually works."
    }
]
