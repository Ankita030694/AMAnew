...
const expanded3b = generateParagraph(section3b, 2);
const expanded4a = generateParagraph(section4a, 2);
const expanded4b = generateParagraph(section4b, 2);
            ...
            <div className="min-w-0">
              ...
              <article className="bg-white p-3 md:p-12 rounded-2xl shadow-sm space-y-6 md:space-y-12">
                ...
                <section id="recognizing-illegal-tactics" className="scroll-mt-32">
                  ...
                  <div dangerouslySetInnerHTML={{ __html: \`\${redFlagsList}\` }} />
                </section>
                ...
                <section id="immediate-actions" className="scroll-mt-32">
                  ...
                  <div dangerouslySetInnerHTML={{ __html: \`\${caseStudy}\` }} />
