...
export default function StateGrid({ bankName, bankSlug }: { bankName: string, bankSlug: string }) {
  ...
  return (
    <section id="state-directory" className="scroll-mt-32 mt-12 bg-white p-6 md:p-8 rounded-2xl border border-gray-100 shadow-sm">
      <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-2">
        {bankName} Settlement Services by State
      </h2>
      <p className="text-gray-600 mb-6 pb-4 border-b border-gray-100">
        Select your state or union territory below to understand the specific legal framework and local police authorities you can utilize to stop {bankName} harassment.
      </p>
