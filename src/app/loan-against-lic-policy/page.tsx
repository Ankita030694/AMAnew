...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://www.amalegalsolutions.com/loan-against-lic-policy"
    }
  ]
};
...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.amalegalsolutions.com/loan-against-lic-policy',
  },
};
...
export default function Page() {
  ...
  const breadcrumbItems = [
    { label: "Home", href: "/" },
    { label: "Loan Against LIC Policy", href: "/loan-against-lic-policy" },
  ];
...
<section id="understanding-mechanism" className="scroll-mt-32">
  <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">As of 2023, the Reserve Bank of India reported that average unsecured personal loan interest rates hovered around 11% to 24%, while a loan against an LIC policy can be secured at a significantly lower rate, typically around 9% to 10% per annum. This stark 200 to 1500 basis point differential makes leveraging your existing life insurance a mathematically superior strategy for sudden liquidity needs.</p>
