            ...
            <div className="min-w-0">
              ...
              <article className="bg-white p-6 md:p-12 rounded-2xl shadow-sm space-y-8 md:space-y-12">
                ...
                <section id="resolution-mechanisms" className="scroll-mt-32">
                  ...
                  <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                    To secure a favorable OTS, you must demonstrate genuine financial hardship. Prepare a comprehensive dossier including your income statements, medical bills, or termination letters. <strong>Never accept the first offer</strong> made by the bank's recovery agents; always negotiate for a lower amount. Read more about <Link href="/loan-write-off-vs-loan-settlement" className="text-[#D2A02A] hover:underline font-semibold">the difference between loan write-off and loan settlement</Link> to understand exactly what you are agreeing to.
                  </p>
