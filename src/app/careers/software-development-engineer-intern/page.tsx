...
export const metadata: Metadata = {
  ...
  description: "Apply for Software Development Engineer Internship at AMA Legal Solutions. Build modern Legal Tech with Next.js and React in Gurugram. Apply today.",
