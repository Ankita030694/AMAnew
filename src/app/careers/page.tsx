...
const CareersPage = () => {
  return (
    <div className="min-h-screen bg-[#F8F5EC] font-[family-name:var(--font-polysans)]">
      ...
      <main className="pt-[96px] md:pt-[120px] pb-[80px] md:pb-[100px] px-4 md:px-8 max-w-[1200px] mx-auto sm:mt-30 md:mt-0">
        <header className="mb-12 md:mb-16 text-center">
          <h1 className="text-[32px] md:text-[60px] font-bold text-[#30261C] leading-tight mb-5 md:mb-6">
            Join Our Mission
          </h1>
          <p className="text-[14px] md:text-[22px] text-[#30261C]/80 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
          {/* Left: Open Positions */}
          <section>
            <h2 className="text-2xl md:text-3xl font-bold text-[#30261C] mb-6 md:mb-8">Open Positions</h2>
            <div className="space-y-5 md:space-y-6">
              {OPEN_POSITIONS.map((job) => (
                <div 
                  key={job.title}
                  className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-[#D2A02A]/10 hover:shadow-md transition-shadow"
                >
                  <div className="flex justify-between items-start mb-3 md:mb-4">
                    <div>
                      <h3 className="text-base md:text-xl font-bold text-[#30261C]">{job.title}</h3>
                      <p className="text-xs md:text-sm text-[#D2A02A] font-semibold">{job.type} • {job.location}</p>
                    </div>
                  </div>
                  <p className="text-sm md:text-base text-[#30261C]/80 leading-relaxed mb-3 md:mb-4">
                    {job.description}
                  </p>
                  <Link 
                    href={`/careers/${job.slug}`}
                    className="text-sm md:text-base text-[#D2A02A] font-semibold hover:underline flex items-center gap-2 group"
                  >
        ...
        <section className="mt-20 md:mt-24">
          <h2 className="text-2xl md:text-3xl font-bold text-[#30261C] mb-5 md:mb-6 text-center">
            Why Work With AMA Legal Solutions?
          </h2>
          <p className="text-sm md:text-lg text-[#30261C]/75 leading-relaxed text-center max-w-3xl mx-auto mb-10 md:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white p-6 md:p-8 rounded-2xl border border-[#D2A02A]/10 shadow-sm">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-[#D2A02A]/10 rounded-xl flex items-center justify-center mb-3 md:mb-4">
                <svg className="w-5 h-5 md:w-6 md:h-6 text-[#D2A02A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-base md:text-xl font-bold text-[#30261C] mb-2 md:mb-3">High-Impact Work</h3>
              <p className="text-sm md:text-base text-[#30261C]/70 leading-relaxed">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl border border-[#D2A02A]/10 shadow-sm">
              ...
              <h3 className="text-base md:text-xl font-bold text-[#30261C] mb-2 md:mb-3">Continuous Learning</h3>
              <p className="text-sm md:text-base text-[#30261C]/70 leading-relaxed">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl border border-[#D2A02A]/10 shadow-sm">
              ...
              <h3 className="text-base md:text-xl font-bold text-[#30261C] mb-2 md:mb-3">Collaborative Culture</h3>
              <p className="text-sm md:text-base text-[#30261C]/70 leading-relaxed">
        ...
        <section className="mt-16 md:mt-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-[#30261C] mb-5 md:mb-6">
                What We Look For
              </h2>
              <p className="text-sm md:text-base text-[#30261C]/75 leading-relaxed mb-5 md:mb-6">
              ...
              <ul className="space-y-3 md:space-y-4 text-sm md:text-base text-[#30261C]/75">
            ...
            <div className="bg-[#30261C] text-[#F8F5EC] p-8 md:p-10 rounded-2xl">
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4">Life at AMA</h3>
              <p className="text-sm md:text-base leading-relaxed opacity-80 mb-5 md:mb-6">
        ...
        {/* Equal Opportunity */}
        <section className="mt-12 md:mt-16 text-center bg-white p-8 md:p-10 rounded-2xl border border-[#D2A02A]/10">
          <h2 className="text-xl md:text-2xl font-bold text-[#30261C] mb-3 md:mb-4">Equal Opportunity Employer</h2>
          <p className="text-sm md:text-base text-[#30261C]/70 leading-relaxed max-w-3xl mx-auto">
