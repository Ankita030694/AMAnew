...
const faqs = [
  {
    question: "What legal domains will I work on as a Legal Intern at AMA?",
    answer: "Our practice is diverse. You will primarily assist with Loan Settlement negotiations, Intellectual Property (Trademarks/Copyrights), Arbitration, Civil Litigation, and Corporate Compliance. We encourage interns to learn broadly while experiencing the firm's core areas."
  },
  {
  ...
  {
    question: "What is the work-life balance like for Legal Interns?",
...
const breadcrumbSchema = (baseUrl: string) => ({
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Legal Intern", "item": `${baseUrl}/careers/legal-intern` }
  ]
});
...
const jobPostingSchema = (baseUrl: string) => ({
  ...
  "@type": "JobPosting",
  "title": "Legal Intern",
  "description": "Join the legal team at AMA Legal Solutions as a Legal Intern. Gain hands-on experience in high-impact litigation, IPR, and loan settlement cases.",
  "identifier": {
    "@type": "PropertyValue",
...
const articleSchema = (baseUrl: string) => ({
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Legal Intern Jobs in Gurugram | AMA Legal Solutions Careers",
  "description": "Join the legal team at AMA Legal Solutions as a Legal Intern. Gain hands-on experience in high-impact litigation, IPR, and loan settlement cases.",
...
export default function LegalInternPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: "Legal Intern", href: "/careers/legal-intern" },
  ];
        ...
        <div className="relative bg-[#1a202c] text-white">
          ...
          <div className="relative z-20 container mx-auto px-4 py-12 md:py-32 text-center">
            <h1 className="text-2xl md:text-6xl font-bold mb-4 md:mb-6 leading-tight mt-10">
              Kickstart your Legal Career as a <span className="text-[#D2A02A]">Legal Intern</span>
            </h1>
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-3 md:p-12 rounded-2xl shadow-sm space-y-6 md:space-y-12">
                ...
                <section id="introduction" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">A Dynamic Practice for Aspiring Lawyers</h2>
                  <p className="text-sm md:text-lg leading-relaxed text-gray-700">
                    AMA Legal Solutions is built on the pillars of legal precision and client-centricity. As a <strong>Legal Intern</strong>, you will assist in our legal operations, learning about a diverse portfolio of cases that range from high-stakes <strong>loan settlement negotiations</strong> to complex <strong>intellectual property litigation</strong>. We look for analytical minds who are eager to navigate the complexities of Indian law while providing practical, effective solutions to our clients.
                  </p>
                </section>
                ...
                <section id="requirements" className="scroll-mt-32">
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-sm md:text-lg text-gray-700">
                    <li>Pursuing LL.B / B.A. LL.B from a recognized university.</li>
                    <li>Strong interest in litigation and corporate practice.</li>
                    <li>Previous internship experience in litigation or corporate practice is a plus.</li>
                  ...
                  <div className="relative">
                    ...
                    <div className="space-y-8 relative">
                      {[
                        ...
                        { step: "4", title: "Onboarding", text: "Start your internship at our Gurugram headquarters." }
                      ].map((s, i) => (
            ...
            <div className="hidden lg:block space-y-8 sticky top-24">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 mb-6 text-sm">
                    Ready to kickstart your legal career? Apply for the Legal Intern position in Gurugram.
                  </p>
                  <Link 
