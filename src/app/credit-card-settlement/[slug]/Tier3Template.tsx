...
export default function Tier3Template({ bankName, slug }: { bankName: string, slug: string }) {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
      "@type": "Question",
      "name": `How do I correctly and legally initiate a ${bankName} credit card settlement process?`,
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": `No, ${bankName} is not legally required to accept any settlement offer. They evaluate proposals based on strict internal algorithmic risk parameters. However, because credit card debt is completely unsecured, modern lenders are heavily financially motivated to settle and clear their books rather than engage in prolonged, expensive civil litigation.`
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": `Can ${bankName} initiate criminal proceedings against me for defaulting on my digital credit card?`,
      "acceptedAnswer": {
        "@type": "Answer",
        "text": `No. Defaulting on an unsecured ${bankName} credit card is exclusively a civil legal matter, not a criminal offense. They cannot register an FIR or facilitate your arrest for inability to pay, provided the credit limit was not obtained using fraudulent digital documentation.`
      }
    },
    {
      "@type": "Question",
            ...
            <main className="min-w-0">
              ...
              <article className="bg-white p-3 md:p-12 rounded-2xl shadow-sm space-y-6 md:space-y-12">
                ...
                <section id="legal-framework" className="scroll-mt-32">
                  ...
                  <p className="text-sm md:text-lg leading-relaxed mb-6 text-gray-700">{`A critical, highly effective legal concept in debt negotiation with ${bankName} is the strict statute of limitations. In India, for unsecured digital debts such as credit cards, this limitation period is legally capped at exactly three years from the exact date of your last payment. If ${bankName} fails to file formal, legitimate civil suits within this precise window, the debt becomes legally time-barred, drastically and permanently shifting the settlement leverage in your favor.`}</p>
                ...
                <section id="post-settlement" className="scroll-mt-32">
                  ...
                  <p className="text-sm md:text-lg leading-relaxed mb-6 text-gray-700">{`Reaching a verbal consensus or an informal chat agreement with a ${bankName} executive is only the preliminary phase. The finalization of a credit card settlement is a strictly formal, legally binding procedure that demands meticulous attention to documentation to guarantee ${bankName} cannot legally pursue you for the waived balance at a later date.`}</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 relative shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-700 italic mb-4 relative z-10">
                          "{`I was constantly harassed by ${bankName} agents over a small outstanding amount that blew up due to insane hidden penalties. AMA Legal Solutions stepped in, completely stopped the daily automated harassment, and negotiated a massive settlement focused only on the principal. Truly a lifesaver.`}"
                        </p>
                      ...
                      <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 relative shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-700 italic mb-4 relative z-10">
                          "{`The ${bankName} digital legal notices were terrifying, and their agents were incredibly aggressive on WhatsApp. The lawyers at AMA Legal Solutions quickly deciphered the notices as pressure tactics, protected my privacy, and secured a brilliant One Time Settlement. I cannot recommend their services enough.`}"
                        </p>
                        <div className="flex items-center">
                          <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center text-gray-600 font-bold mr-3">
                            N
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="border-b border-gray-200 pb-6 last:border-0 hover:bg-gray-50 p-4 transition-colors rounded-lg">
                        <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-start">
                          ...
                          {`How do I correctly and legally initiate a ${bankName} credit card settlement process?`}
                        </h3>
                      ...
                      <div className="border-b border-gray-200 pb-6 last:border-0 hover:bg-gray-50 p-4 transition-colors rounded-lg">
                        <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-start">
                          <span className="text-[#D2A02A] mr-3 mt-1 shadow-sm">Q.</span>
                          {`Can ${bankName} initiate criminal proceedings against me for defaulting on my digital credit card?`}
                        </h3>
                        <p className="text-gray-700 leading-relaxed pl-8">
                          {`No. Defaulting on an unsecured ${bankName} credit card is exclusively a civil legal matter, not a criminal offense. They cannot register an FIR or facilitate your arrest for inability to pay, provided the credit limit was not obtained using fraudulent digital documentation.`}
                        </p>
                      </div>
