...
export default function Tier1Template({ bankName, slug }: { bankName: string, slug: string }) {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
      "@type": "Question",
      "name": `How do I legally initiate a ${bankName} credit card settlement process?`,
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": `What specifically happens if I simply stop paying my ${bankName} credit card bill entirely?`,
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": `What is a realistic discount percentage I can expect during a ${bankName} credit card settlement?`,
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": `Do I absolutely need to hire a lawyer to negotiate a ${bankName} credit card settlement?`,
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": `Can ${bankName} file a criminal case against me for simply defaulting on my credit card?`,
      "acceptedAnswer": {
        "@type": "Answer",
        "text": `No. Defaulting on an unsecured ${bankName} credit card is strictly a civil matter, not a criminal offense. They cannot file an FIR or have you arrested simply because you are unable to pay. The only exception is if you used fraudulent documents to obtain the card.`
      }
    },
    {
      "@type": "Question",
      "name": `Will settling my ${bankName} credit card completely ruin my chances of getting a home loan in the future?`,
      "acceptedAnswer": {
        "@type": "Answer",
            ...
            <main className="min-w-0">
              ...
              <article className="bg-white p-3 md:p-12 rounded-2xl shadow-sm space-y-6 md:space-y-12">
                ...
                <section id="step-by-step-process" className="scroll-mt-32">
                  ...
                  <p className="text-sm md:text-lg leading-relaxed mb-6 text-gray-700">{`Executing a successful and permanent ${bankName} credit card settlement requires a highly strategic, methodical, and unemotional approach. You must expertly navigate a structured sequence of actions that clearly demonstrate your severe financial hardship, neutralize ${bankName}'s aggressive automated recovery systems, and effectively force a meaningful negotiation with their authorized senior decision-makers rather than low-level call center employees.`}</p>
                  
                  <p className="text-sm md:text-lg leading-relaxed mb-6 text-gray-700">{`The absolute first actionable step when you anticipate defaulting on a ${bankName} credit card is to aggressively protect your liquid cash flow. If your credit card bill is set to auto-debit (NACH/ECS) from a linked savings account, you must immediately and formally revoke this mandate. Controlling your cash flow is of paramount importance; you simply cannot negotiate a settlement from a position of strength if ${bankName} is automatically draining your financial resources every month.`}</p>
                ...
                <section id="dealing-with-recovery-agents" className="scroll-mt-32">
                  ...
                  <p className="text-sm md:text-lg leading-relaxed mb-6 text-gray-700">{`Undeniably, the most distressing, terrifying, and psychologically damaging aspect of defaulting on a ${bankName} credit card is the forced interaction with their recovery agents. Large national banks heavily outsource their collection activities to aggressive, heavily incentivized third-party collection agencies. These agencies are meticulously trained to create a false sense of absolute urgency, paralyzing fear, and impending legal doom.`}</p>
                ...
                <section id="post-settlement" className="scroll-mt-32">
                  ...
                  <p className="text-sm md:text-lg leading-relaxed mb-6 text-gray-700">{`Once the ${bankName} account is legally settled and documented, the financial bleeding stops entirely. You can immediately begin the process of rebuilding your credit profile using secured credit lines, such as a credit card backed by a fixed deposit. Rebuilding takes time, patience, and financial discipline, but it is entirely predictable and achievable once the crushing, suffocating burden of ${bankName} credit card debt is legally eradicated.`}</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 relative shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-700 italic mb-4 relative z-10">
                          "{`I was completely drowning in ${bankName} credit card debt after a sudden medical emergency in the family. AMA Legal Solutions stepped in, completely halted the highly abusive calls from agents within 48 hours, and successfully negotiated a settlement that saved me over 65%. I finally have peace of mind and my life back.`}"
                        </p>
                      ...
                      <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 relative shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-700 italic mb-4 relative z-10">
                          "{`The ${bankName} recovery agents were aggressively threatening to visit my office and humiliate me in front of my boss. The legal team at AMA immediately sent a cease and desist notice, permanently stopping the harassment the very next day. They then secured an incredible One Time Settlement for a fraction of the cost. Highly professional service.`}"
                        </p>
                        <div className="flex items-center">
                          <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center text-gray-600 font-bold mr-3">
                            S
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="border-b border-gray-200 pb-6 last:border-0 hover:bg-gray-50 p-4 transition-colors rounded-lg">
                        <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-start">
                          ...
                          {`How do I legally initiate a ${bankName} credit card settlement process?`}
                        </h3>
                      ...
                      <div className="border-b border-gray-200 pb-6 last:border-0 hover:bg-gray-50 p-4 transition-colors rounded-lg">
                        <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-start">
                          <span className="text-[#D2A02A] mr-3 mt-1 shadow-sm">Q.</span>
                          {`What specifically happens if I simply stop paying my ${bankName} credit card bill entirely?`}
                        </h3>
                        <p className="text-gray-700 leading-relaxed pl-8">
                      ...
                      <div className="border-b border-gray-200 pb-6 last:border-0 hover:bg-gray-50 p-4 transition-colors rounded-lg">
                        <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-start">
                          <span className="text-[#D2A02A] mr-3 mt-1 shadow-sm">Q.</span>
                          {`What is a realistic discount percentage I can expect during a ${bankName} credit card settlement?`}
                        </h3>
                        <p className="text-gray-700 leading-relaxed pl-8">
                      ...
                      <div className="border-b border-gray-200 pb-6 last:border-0 hover:bg-gray-50 p-4 transition-colors rounded-lg">
                        <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-start">
                          <span className="text-[#D2A02A] mr-3 mt-1 shadow-sm">Q.</span>
                          {`Do I absolutely need to hire a lawyer to negotiate a ${bankName} credit card settlement?`}
                        </h3>
                        <p className="text-gray-700 leading-relaxed pl-8">
                      ...
                      <div className="border-b border-gray-200 pb-6 last:border-0 hover:bg-gray-50 p-4 transition-colors rounded-lg">
                        <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-start">
                          <span className="text-[#D2A02A] mr-3 mt-1 shadow-sm">Q.</span>
                          {`Can ${bankName} file a criminal case against me for simply defaulting on my credit card?`}
                        </h3>
                        <p className="text-gray-700 leading-relaxed pl-8">
                          {`No. Defaulting on an unsecured ${bankName} credit card is strictly a civil matter, not a criminal offense. They cannot file an FIR or have you arrested simply because you are unable to pay. The only exception is if you used fraudulent documents to obtain the card.`}
                        </p>
                      </div>
                      ...
                      <div className="border-b border-gray-200 pb-6 last:border-0 hover:bg-gray-50 p-4 transition-colors rounded-lg">
                        <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-start">
                          <span className="text-[#D2A02A] mr-3 mt-1 shadow-sm">Q.</span>
                          {`Will settling my ${bankName} credit card completely ruin my chances of getting a home loan in the future?`}
                        </h3>
                        <p className="text-gray-700 leading-relaxed pl-8">
