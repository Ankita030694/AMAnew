...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://amalegalsolutions.com/services/cyber/${slug}`,
    },
    openGraph: {
      title: content.title,
      description: content.description,
      url: `https://amalegalsolutions.com/services/cyber/${slug}`,
...
function generateWebPageSchema(content: any) {
  return {
    ...
    "name": content.title,
    "description": content.description,
    "url": `https://amalegalsolutions.com/services/cyber/${content.slug}`,
    "mainEntity": {
      "@type": "FAQPage",
...
export default function CyberSlugPage({ params }: { params: { slug: string } }) {
  const slug = params.slug;
  const content = stateContent[slug as keyof typeof stateContent] || unionTerritoryContent[slug as keyof typeof unionTerritoryContent];
