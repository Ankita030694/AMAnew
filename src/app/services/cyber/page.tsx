            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-5 md:p-12 rounded-2xl shadow-sm space-y-6 md:space-y-12">
                ...
                <section id="introduction" className="scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Navigating the Digital Legal Landscape in India</h2>
                ...
                <section id="our-services" className="scroll-mt-32">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                    <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
                      <h3 className="text-lg md:text-xl font-bold text-[#D2A02A] mb-2 md:mb-3">Cyber Crime Defense & Prosecution</h3>
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
                      <h3 className="text-lg md:text-xl font-bold text-[#D2A02A] mb-2 md:mb-3">Online Fraud & Financial Recovery</h3>
                      <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
                      <h3 className="text-lg md:text-xl font-bold text-[#D2A02A] mb-2 md:mb-3">Data Privacy & Compliance</h3>
                      <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
                      <h3 className="text-lg md:text-xl font-bold text-[#D2A02A] mb-2 md:mb-3">Social Media & Defamation</h3>
                      <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
                      <h3 className="text-lg md:text-xl font-bold text-[#D2A02A] mb-2 md:mb-3">E-Commerce & Fintech Law</h3>
                      <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
                      <h3 className="text-lg md:text-xl font-bold text-[#D2A02A] mb-2 md:mb-3">Digital Evidence Management</h3>
                      <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
                    ...
                    <div className="inline-block min-w-full align-middle p-4 md:p-0">
                      <table className="min-w-full bg-white border border-gray-300 rounded-lg overflow-hidden">
                        <thead className="bg-gray-100">
                          <tr>
                            <th className="py-2 md:py-3 px-3 md:px-6 text-left font-bold text-gray-700 border-b text-xs md:text-base">Section</th>
                            <th className="py-2 md:py-3 px-3 md:px-6 text-left font-bold text-gray-700 border-b text-xs md:text-base">Offense / Provision</th>
                          </tr>
                        </thead>
                        <tbody>
                          {[
                            { s: "Section 43", o: "Penalty for damage to computer, computer system, etc. (Civil Liability)" },
                            { s: "Section 65", o: "Tampering with computer source documents" },
                            { s: "Section 66", o: "Computer related offenses (Hacking)" },
                            { s: "Section 66C", o: "Punishment for identity theft" },
                            { s: "Section 66D", o: "Punishment for cheating by personation by using computer resource" },
                            { s: "Section 67", o: "Punishment for publishing or transmitting obscene material in electronic form" },
                          ].map((row, idx) => (
                            <tr key={idx}>
                              <td className="py-2 md:py-3 px-3 md:px-6 border-b text-gray-700 text-xs md:text-base whitespace-nowrap">{row.s}</td>
                              <td className="py-2 md:py-3 px-3 md:px-6 border-b text-gray-700 text-xs md:text-base">{row.o}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                ...
                <section className="bg-gradient-to-br from-[#1a202c] to-[#2d3748] rounded-xl md:rounded-3xl p-6 md:p-16 text-center text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h2 className="text-xl md:text-5xl font-bold mb-4 md:mb-6">Secure Your Digital World Today</h2>
