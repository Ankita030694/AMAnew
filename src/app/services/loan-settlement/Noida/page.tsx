...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://amalegalsolutions.com/services/loan-settlement/Noida',
  },
  openGraph: {
    title: "Loan Settlement in Noida | Expert Debt Relief Lawyers",
    ...
    url: "https://amalegalsolutions.com/services/loan-settlement/Noida",
    type: "website",
    images: [
      {
        url: "/services/3.png",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Noida",
      "item": "https://amalegalsolutions.com/services/loan-settlement/Noida"
    }
  ]
};
