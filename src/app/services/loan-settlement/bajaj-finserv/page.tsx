...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://amalegalsolutions.com/services/loan-settlement/bajaj-finserv',
  },
  openGraph: {
    title: "Bajaj Finserv Loan Settlement | OTS Scheme & Process | AMA Legal Solutions",
    description: "Struggling with Bajaj Finserv loan or EMI card repayment? Expert legal help for Bajaj Finserv loan settlement. Reduce your debt with One Time Settlement (OTS). Stop harassment today.",
    url: "https://amalegalsolutions.com/services/loan-settlement/bajaj-finserv",
    type: "website",
    images: [
      {
        url: "/services/3.png",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://amalegalsolutions.com/services/loan-settlement/bajaj-finserv"
    }
  ]
};
