    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "RBL Bank Loan Settlement Services",
      },
    ],
  },
};
  ...
  "review": [
    {
      ...
      "reviewBody": "I was stuck with a huge RBL credit card bill. AMA Legal Solutions helped me negotiate a 50% waiver. Highly recommended!"
    }
  ]
};
...
export default function RBLBankLoanSettlementPage() {
  const tocSections = [
    ...
    { id: "understanding-settlement", title: "What is RBL Bank OTS?" },
  ...
  const breadcrumbItems = [
    ...
    { label: "RBL Bank", href: "/services/loan-settlement/rbl-bank" },
  ];
  ...
  return (
    <>
      ...
      <div className="bg-white min-h-screen font-sans text-gray-800">
        ...
        <div className="relative bg-gradient-to-r from-[#003a70] to-[#002a50] text-white overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 py-24 md:py-32 text-center">
            <div className="inline-block bg-[#ed1c24] text-white text-xs font-bold px-3 py-1 rounded-full mb-6 tracking-wide uppercase">
              RBL Bank Specialization
            </div>
            <h1 className="text-4xl md:text-7xl font-extrabold mb-6 leading-tight tracking-tight">
              Settle Your <span className="text-blue-200">RBL Bank Loan</span> <br className="hidden md:block" /> With Legal Protection
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <button className="bg-[#ed1c24] hover:bg-[#c4161d] text-white font-bold py-4 px-10 rounded-lg transition-all transform hover:-translate-y-1 shadow-xl text-lg w-full sm:w-auto">
        ...
        <div className="relative">
          ...
          <div id="introduction" className="container mx-auto px-4 py-12 max-w-4xl text-center scroll-mt-32">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              Financial challenges can arise unexpectedly. A sudden job loss, a medical emergency, or a business downturn can make it impossible to keep up with loan EMIs. If you are facing such a situation with your <strong>RBL Bank personal loan</strong> or <strong>credit card dues</strong>, you are not alone. Thousands of borrowers find themselves in a debt trap where high interest rates and penalties make repayment seem impossible.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
          ...
          <div id="understanding-settlement" className="bg-gray-50 py-20 scroll-mt-32">
            <div className="container mx-auto px-4 max-w-6xl">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <h2 className="text-3xl font-bold text-[#003a70] mb-6">What is RBL Bank One Time Settlement (OTS)?</h2>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-[#003a70]">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between pt-2">
                      ...
                      <span className="font-bold text-[#003a70]">50% (₹2.5 Lakhs)</span>
                    </div>
                  </div>
          ...
          <div id="eligibility" className="container mx-auto px-4 py-20 max-w-5xl scroll-mt-32">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Who is Eligible for RBL Bank Loan Settlement?</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
                <div className="w-14 h-14 bg-red-100 rounded-full flex items-center justify-center text-[#ed1c24] text-2xl mb-4">
                  <FaUserTie />
                </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
                <div className="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center text-[#003a70] text-2xl mb-4">
                  <FaHandHoldingUsd />
                </div>
            ...
            <div className="container mx-auto px-4 max-w-7xl">
              ...
              <div className="grid md:grid-cols-5 gap-6">
                {[
                  ...
                  { step: "02", title: "Legal Notice", desc: "We inform RBL Bank of our representation to stop harassment." },
                  ...
                  <div key={index} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow border border-gray-100 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                      <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-[#003a70] font-bold mb-4">
                        {item.step}
                      </div>
          ...
          <div id="documents-required" className="container mx-auto px-4 py-20 max-w-5xl scroll-mt-32">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Documents Required for RBL Bank Settlement</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-md border-l-4 border-[#003a70]">
              ...
              <div className="bg-white p-8 rounded-xl shadow-md border-l-4 border-[#ed1c24]">
          ...
          <div id="legal-rights" className="bg-[#002a50] text-white py-20 scroll-mt-32">
            <div className="container mx-auto px-4 max-w-5xl">
              <h2 className="text-3xl font-bold mb-8 text-center">Understanding RBL Bank Legal Notices</h2>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                <div className="flex items-center mb-6">
                  <div className="bg-blue-100 p-3 rounded-full mr-4">
                    <FaShieldAlt className="text-[#003a70] text-2xl" />
                  </div>
                  <h2 className="text-2xl font-bold text-gray-900">Your Legal Rights</h2>
                </div>
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-start">
                    <span className="text-[#003a70] mr-2">●</span> <strong>No Abusive Language:</strong> Recovery agents cannot use foul language or threats.
                  </li>
                  <li className="flex items-start">
                    <span className="text-[#003a70] mr-2">●</span> <strong>Timing:</strong> No calls before 8 AM or after 7 PM.
                  </li>
                  <li className="flex items-start">
                    <span className="text-[#003a70] mr-2">●</span> <strong>Privacy:</strong> They cannot inform your relatives or neighbors about your debt.
                  </li>
                  <li className="flex items-start">
                    <span className="text-[#003a70] mr-2">●</span> <strong>Representation:</strong> You have the right to appoint a lawyer to handle the bank.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="container mx-auto px-4 max-w-6xl text-center">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                  <FaUniversity className="text-5xl text-[#003a70] mx-auto mb-6" />
                  <h3 className="text-xl font-bold mb-3">Bank-Specific Expertise</h3>
                  <p className="text-gray-600">We know RBL Bank's internal settlement policies, hierarchy, and approval limits, giving us an edge in negotiations.</p>
                </div>
                <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                  <FaFileContract className="text-5xl text-[#003a70] mx-auto mb-6" />
                ...
                <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                  <FaShieldAlt className="text-5xl text-[#003a70] mx-auto mb-6" />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 relative">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-bold text-gray-900">Rohit Sharma</p>
          ...
          <div className="container mx-auto px-4 pb-20">
            <div className="bg-[#003a70] rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl">
              <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to Close Your RBL Bank Loan?</h2>
              <p className="text-xl opacity-90 mb-10 max-w-2xl mx-auto">
                Don't let debt define your life. Get expert legal help to settle your RBL Bank loan and start fresh.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/contact">
                  <button className="bg-white text-[#003a70] font-bold py-4 px-12 rounded-full transition-all transform hover:scale-105 shadow-lg text-lg w-full sm:w-auto">
                    Book Free Consultation
                  </button>
                </Link>
                <a href="tel:+918700343611">
                  <button className="bg-transparent border-2 border-white hover:bg-white hover:text-[#003a70] text-white font-bold py-4 px-12 rounded-full transition-all text-lg w-full sm:w-auto">
                    Call: +91-8700343611
                  </button>
                </a>
              </div>
