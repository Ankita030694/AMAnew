...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://amalegalsolutions.com/services/loan-settlement/hero-fincorp',
  },
  openGraph: {
    title: "Hero Fincorp Loan Settlement | OTS Scheme 2025 | AMA Legal Solutions",
    description: "Struggling with Hero Fincorp personal loan or two-wheeler loan repayment? Get expert legal help for Hero Fincorp loan settlement. Reduce your debt with One Time Settlement (OTS). Stop harassment today.",
    url: "https://amalegalsolutions.com/services/loan-settlement/hero-fincorp",
    type: "website",
    images: [
      {
        url: "/services/3.png",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://amalegalsolutions.com/services/loan-settlement/hero-fincorp"
    }
  ]
};
