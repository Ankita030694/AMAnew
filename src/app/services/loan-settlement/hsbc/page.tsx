...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "HSBC Loan Settlement",
      "item": "https://amalegalsolutions.com/services/loan-settlement/hsbc"
    }
  ]
};
...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "HSBC Loan Settlement Process & Policy 2025: Complete Legal Guide",
  "description": "Struggling with HSBC Bank loan repayment? Learn about the HSBC loan settlement process, OTS policies, settlement letter format, and how to settle your personal loan or credit card debt legally.",
...
const reviewSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  "name": "HSBC Loan Settlement Services",
  "image": "https://amalegalsolutions.com/services/3.png",
  "description": "Expert legal assistance for settling HSBC Bank personal loans and credit card dues.",
  "brand": {
    "@type": "Brand",
    "name": "AMA Legal Solutions"
  },
  ...
  "review": [
    {
      ...
      "reviewBody": "I had a huge outstanding on my HSBC credit card. AMA Legal Solutions negotiated a 55% waiver for me. Very professional service."
    },
    {
      "@type": "Review",
      "reviewRating": {
      ...
      "reviewBody": "My personal loan was in default for 1.5 years. The team helped me get a settlement letter from HSBC within 3 months. Highly recommended."
    }
  ]
};
...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://amalegalsolutions.com/services/loan-settlement/hsbc',
  },
  openGraph: {
    title: "HSBC Loan Settlement Process | HSBC Personal Loan Settlement Letter Format",
    ...
    url: "https://amalegalsolutions.com/services/loan-settlement/hsbc",
    type: "website",
    images: [
      {
        url: "/services/3.png",
        width: 1200,
        height: 630,
        alt: "HSBC Loan Settlement Services",
      },
    ],
  },
};

export default function HSBCLoanSettlementPage() {
  const tocSections = [
    { id: "introduction", title: "Introduction" },
    { id: "what-is-ots", title: "What is HSBC OTS?" },
  ...
  const breadcrumbItems = [
    ...
    { label: "HSBC Loan Settlement", href: "/services/loan-settlement/hsbc" },
  ];
  ...
  return (
    <>
      ...
      <div className="bg-white min-h-screen font-sans text-gray-800">
        ...
        <div className="relative bg-gradient-to-r from-[#db0011] to-[#8a000b] text-white overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 py-24 md:py-32 text-center">
            <div className="inline-block bg-white text-[#db0011] text-xs font-bold px-3 py-1 rounded-full mb-6 tracking-wide uppercase">
              HSBC Bank Specialization
            </div>
            <h1 className="text-4xl md:text-7xl font-extrabold mb-6 leading-tight tracking-tight">
              Settle Your <span className="text-gray-200">HSBC Loan</span> <br className="hidden md:block" /> With Legal Protection
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <button className="bg-white hover:bg-gray-100 text-[#db0011] font-bold py-4 px-10 rounded-lg transition-all transform hover:-translate-y-1 shadow-xl text-lg w-full sm:w-auto">
        ...
        <div id="what-is-ots" className="bg-gray-50 py-20 scroll-mt-32">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-[#db0011] mb-6">What is HSBC One Time Settlement (OTS)?</h2>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700"><strong>Waiver of Interest:</strong> The bank often waives off penal interest and other accumulated charges.</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheckCircle className="text-green-500 mt-1 mr-3 flex-shrink-0" />
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-[#db0011]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between pt-2">
                    ...
                    <span className="font-bold text-[#db0011]">50% (₹2.5 Lakhs)</span>
                  </div>
                </div>
        ...
        <div id="eligibility" className="container mx-auto px-4 py-20 max-w-5xl scroll-mt-32">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Who is Eligible for HSBC Loan Settlement?</h2>
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            ...
            <div className="grid md:grid-cols-5 gap-6">
              {[
                ...
                { step: "02", title: "Legal Notice", desc: "We inform HSBC Bank of our representation to stop harassment." },
                { step: "03", title: "Proposal", desc: "We draft and submit a realistic settlement proposal to the bank." },
                ...
                <div key={index} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow border border-gray-100 relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    <div className="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center text-[#db0011] font-bold mb-4">
                      {item.step}
                    </div>
            ...
            <div className="mt-12 bg-white p-8 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-bold text-[#db0011] mb-2">Step 1: Documentation & Assessment</h4>
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#db0011] mb-2">Step 2: Legal Shielding</h4>
                  <p className="text-gray-700">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#db0011] mb-2">Step 3: The Settlement Proposal</h4>
                  <p className="text-gray-700">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#db0011] mb-2">Step 4: Hard-Nosed Negotiation</h4>
                  <p className="text-gray-700">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#db0011] mb-2">Step 5: Final Settlement & NDC</h4>
                  <p className="text-gray-700">
        ...
        <div id="documents" className="container mx-auto px-4 py-20 max-w-5xl scroll-mt-32">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Documents Required for HSBC Settlement</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-md border-l-4 border-blue-600">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-center"><FaCheckCircle className="text-blue-500 mr-2"/> All notices received from the bank</li>
                <li className="flex items-center"><FaCheckCircle className="text-blue-500 mr-2"/> Credit Card Statements (if applicable)</li>
              </ul>
            </div>
        ...
        <div id="legal-notices" className="bg-[#1a1a1a] text-white py-20 scroll-mt-32">
          <div className="container mx-auto px-4 max-w-5xl">
            <h2 className="text-3xl font-bold mb-8 text-center">Understanding HSBC Legal Notices</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20">
                ...
                <p className="text-gray-300 text-sm mb-4">
                  Issued for <strong>Cheque Bounce</strong> or ECS failure. This is a criminal offense in India.
                </p>
              ...
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20">
                ...
                <p className="text-gray-300 text-sm mb-4">
                  Issued for <strong>Secured Loans</strong> (Home/Property). It warns of asset seizure.
                </p>
                <p className="text-white font-semibold text-sm">
                  <strong>Our Action:</strong> We file objections, approach the DRT (Debt Recovery Tribunal) if necessary, and negotiate to save your property.
                </p>
              </div>
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20">
        ...
        <div id="restructuring-vs-settlement" className="container mx-auto px-4 py-20 max-w-5xl scroll-mt-32">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse bg-white shadow-lg rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-[#db0011] text-white">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              <div className="flex items-center mb-6">
                <div className="bg-blue-100 p-3 rounded-full mr-4">
                  <FaShieldAlt className="text-[#db0011] text-2xl" />
                </div>
                <h2 className="text-2xl font-bold text-gray-900">Your Legal Rights</h2>
              </div>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <span className="text-[#db0011] mr-2">●</span> <strong>No Abusive Language:</strong> Recovery agents cannot use foul language or threats.
                </li>
                <li className="flex items-start">
                  <span className="text-[#db0011] mr-2">●</span> <strong>Timing:</strong> No calls before 8 AM or after 7 PM.
                </li>
                <li className="flex items-start">
                  <span className="text-[#db0011] mr-2">●</span> <strong>Privacy:</strong> They cannot inform your relatives or neighbors about your debt.
                </li>
                <li className="flex items-start">
                  <span className="text-[#db0011] mr-2">●</span> <strong>Representation:</strong> You have the right to appoint a lawyer to handle the bank.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 max-w-6xl text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                <FaUniversity className="text-5xl text-[#db0011] mx-auto mb-6" />
                <h3 className="text-xl font-bold mb-3">Bank-Specific Expertise</h3>
                <p className="text-gray-600">We know HSBC's internal settlement policies, hierarchy, and approval limits, giving us an edge in negotiations.</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                <FaFileContract className="text-5xl text-[#db0011] mx-auto mb-6" />
              ...
              <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                <FaShieldAlt className="text-5xl text-[#db0011] mx-auto mb-6" />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 relative">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-bold text-gray-900">Rohan Das</p>
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-[#db0011] rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to Close Your HSBC Loan?</h2>
            <p className="text-xl opacity-90 mb-10 max-w-2xl mx-auto">
              Don't let debt define your life. Get expert legal help to settle your HSBC loan and start fresh.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <button className="bg-white text-[#db0011] font-bold py-4 px-12 rounded-full transition-all transform hover:scale-105 shadow-lg text-lg w-full sm:w-auto">
                  Book Free Consultation
                </button>
              </Link>
              <a href="tel:+918700343611">
                <button className="bg-transparent border-2 border-white hover:bg-white hover:text-[#db0011] text-white font-bold py-4 px-12 rounded-full transition-all text-lg w-full sm:w-auto">
                  Call: +91-8700343611
                </button>
              </a>
            </div>
