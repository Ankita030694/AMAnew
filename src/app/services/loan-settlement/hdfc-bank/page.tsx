...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://www.amalegalsolutions.com/services/loan-settlement/hdfc-bank"
    }
  ]
};
  ...
  "review": [
    {
      ...
      "reviewBody": "I had a huge outstanding on my HDFC credit card. AMA Legal Solutions negotiated a 60% waiver for me. Very professional service."
    },
    {
      "@type": "Review",
      "reviewRating": {
      ...
      "reviewBody": "My personal loan was in default for 2 years. The team helped me get a settlement letter from HDFC within 2 months. Highly recommended."
    }
  ]
};
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "HDFC Loan Settlement Services",
      },
    ],
  },
};
...
export default function HDFCLoanSettlementPage() {
  const tocSections = [
    ...
    { id: "what-is-ots", title: "What is HDFC OTS?" },
  ...
  const breadcrumbItems = [
    ...
    { label: "HDFC Loan Settlement", href: "/services/loan-settlement/hdfc-bank" },
  ];
      ...
      <div className="bg-white min-h-screen font-sans text-gray-800">
        ...
        <div className="relative bg-gradient-to-r from-[#004c8f] to-[#003366] text-white overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 py-24 md:py-32 text-center">
            <div className="inline-block bg-red-600 text-white text-xs font-bold px-3 py-1 rounded-full mb-6 tracking-wide uppercase">
              HDFC Bank Specialization
            </div>
            <h1 className="text-4xl md:text-7xl font-extrabold mb-6 leading-tight tracking-tight">
              Settle Your <span className="text-blue-200">HDFC Loan</span> <br className="hidden md:block" /> With Legal Protection
            </h1>
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-blue-100 font-light">
              Stop harassment, reduce your debt by up to 50%, and close your HDFC personal loan or credit card permanently.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-10 rounded-lg transition-all transform hover:-translate-y-1 shadow-xl text-lg w-full sm:w-auto">
        ...
        <div id="introduction" className="container mx-auto px-4 py-12 max-w-4xl text-center scroll-mt-32">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
            Trapped in HDFC Debt? There is a Way Out.
          </h2>
        ...
        <div id="what-is-ots" className="bg-gray-50 py-20 scroll-mt-32">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-[#004c8f] mb-6">What is HDFC One Time Settlement (OTS)?</h2>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-[#004c8f]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between pt-2">
                    ...
                    <span className="font-bold text-[#004c8f]">50% (₹2.5 Lakhs)</span>
                  </div>
                </div>
        ...
        <div id="eligibility" className="container mx-auto px-4 py-20 max-w-5xl scroll-mt-32">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Who is Eligible for HDFC Loan Settlement?</h2>
        ...
        <div id="process" className="bg-[#f8fafc] py-20 scroll-mt-32">
          <div className="container mx-auto px-4 max-w-7xl">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-16">
              Our 5-Step HDFC Settlement Process
            </h2>
            <div className="grid md:grid-cols-5 gap-6">
              {[
                { step: "01", title: "Case Evaluation", desc: "We review your documents to prove genuine financial hardship." },
                { step: "02", title: "Legal Notice", desc: "We inform HDFC Bank of our representation to stop harassment." },
            ...
            <div className="mt-12 bg-white p-8 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-bold text-[#004c8f] mb-2">Step 1: Documentation & Assessment</h4>
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#004c8f] mb-2">Step 2: Legal Shielding</h4>
                  <p className="text-gray-700">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#004c8f] mb-2">Step 4: Hard-Nosed Negotiation</h4>
                  <p className="text-gray-700">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#004c8f] mb-2">Step 5: Final Settlement & NDC</h4>
                  <p className="text-gray-700">
        ...
        <div id="documents" className="container mx-auto px-4 py-20 max-w-5xl scroll-mt-32">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Documents Required for HDFC Settlement</h2>
        ...
        <div id="legal-notices" className="bg-[#003366] text-white py-20 scroll-mt-32">
          <div className="container mx-auto px-4 max-w-5xl">
            <h2 className="text-3xl font-bold mb-8 text-center">Understanding HDFC Legal Notices</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <span className="text-[#004c8f] mr-2">●</span> <strong>No Abusive Language:</strong> Recovery agents cannot use foul language or threats.
                </li>
                <li className="flex items-start">
                  <span className="text-[#004c8f] mr-2">●</span> <strong>Timing:</strong> No calls before 8 AM or after 7 PM.
                </li>
                <li className="flex items-start">
                  <span className="text-[#004c8f] mr-2">●</span> <strong>Privacy:</strong> They cannot inform your relatives or neighbors about your debt.
                </li>
                <li className="flex items-start">
                  <span className="text-[#004c8f] mr-2">●</span> <strong>Representation:</strong> You have the right to appoint a lawyer to handle the bank.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 max-w-6xl text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">We know HDFC's internal settlement policies, hierarchy, and approval limits, giving us an edge in negotiations.</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="bg-[#004c8f] rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to Close Your HDFC Loan?</h2>
            <p className="text-xl opacity-90 mb-10 max-w-2xl mx-auto">
              Don't let debt define your life. Get expert legal help to settle your HDFC loan and start fresh.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
