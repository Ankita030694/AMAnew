...
export const metadata = {
  title: "Zype Loan Settlement | AMA Legal",
  description:
    "End your Zype credit line crisis with expert legal help. AMA Legal Solutions specializes in digital app loan settlements. founded by anuj anand malik in.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Resolve your Zype outstanding dues through a professional legal settlement. our firm in sector 57 will handle all negotiations and protect your rights..",
