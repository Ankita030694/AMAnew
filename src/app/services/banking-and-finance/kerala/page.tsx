...
export const metadata = {
  ...
  alternates: {
    canonical: "https://amalegalsolutions.com/services/banking-and-finance/kerala",
  },
  openGraph: {
    title: "Banking and Finance Services in Kerala | Gold Loan & NBFC Registration",
    description:
      "Expert legal consultancy for Banking & Finance in Kerala. Services include Gold Loan NBFC Registration, Chitty Business, Nidhi Company, & DRT Litigation in Kochi.",
    url: "https://amalegalsolutions.com/services/banking-and-finance/kerala",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Kerala",
      item: "https://amalegalsolutions.com/services/banking-and-finance/kerala",
    },
  ],
};
