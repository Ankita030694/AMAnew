...
export const metadata = {
  ...
  alternates: {
    canonical: "https://amalegalsolutions.com/services/banking-and-finance/bihar",
  },
  openGraph: {
    title: "Banking and Finance Services in Bihar | NBFC Registration & DRT Patna",
    description:
      "Expert legal consultancy for Banking & Finance in Bihar. Services include NBFC Registration in Patna, Nidhi Company setup, Bihar Money Lenders License & DRT Litigation.",
    url: "https://amalegalsolutions.com/services/banking-and-finance/bihar",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Bihar",
      item: "https://amalegalsolutions.com/services/banking-and-finance/bihar",
    },
  ],
};
