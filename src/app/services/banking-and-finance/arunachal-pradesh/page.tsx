...
export const metadata = {
  ...
  alternates: {
    canonical: "https://amalegalsolutions.com/services/banking-and-finance/arunachal-pradesh",
  },
  openGraph: {
    title: "Banking and Finance Services in Arunachal Pradesh | NBFC & LPC Loans",
    description:
      "Expert legal consultancy for Banking & Finance in Arunachal Pradesh. Services include NBFC Registration in Itanagar, Land Possession Certificate (LPC) loan compliance, ILP & Trading Licenses.",
    url: "https://amalegalsolutions.com/services/banking-and-finance/arunachal-pradesh",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://amalegalsolutions.com/services/banking-and-finance/arunachal-pradesh",
    },
  ],
};
