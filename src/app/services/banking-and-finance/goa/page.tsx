...
export const metadata = {
  ...
  alternates: {
    canonical: "https://amalegalsolutions.com/services/banking-and-finance/goa",
  },
  openGraph: {
    title: "Banking and Finance Services in Goa | NBFC Registration & Casino Finance Law",
    description:
      "Expert legal consultancy for Banking & Finance in Goa. Services include NBFC Registration, Casino & Tourism Finance, Nidhi Company, Money Lenders License & DRT Litigation in Panaji.",
    url: "https://amalegalsolutions.com/services/banking-and-finance/goa",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Goa",
      item: "https://amalegalsolutions.com/services/banking-and-finance/goa",
    },
  ],
};
