...
export const metadata = {
  ...
  alternates: {
    canonical: "https://amalegalsolutions.com/services/banking-and-finance/jharkhand",
  },
  openGraph: {
    title: "Banking and Finance Services in Jharkhand | NBFC Registration & DRT",
    description:
      "Expert legal consultancy for Banking & Finance in Jharkhand. Services include NBFC Registration in Ranchi, Tribal Finance (CNT/SPT) compliance, Money Lenders License & DRT Litigation.",
    url: "https://amalegalsolutions.com/services/banking-and-finance/jharkhand",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Jharkhand",
      item: "https://amalegalsolutions.com/services/banking-and-finance/jharkhand",
    },
  ],
};
