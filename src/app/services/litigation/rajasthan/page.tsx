...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Rajasthan",
      "item": "https://amalegalsolutions.com/services/litigation/rajasthan"
    }
  ]
};
...
const articleSchema = {
  ...
  "image": "https://amalegalsolutions.com/services/litigation-rajasthan.png", // Placeholder
  "author": {
    "@type": "Organization",
...
const reviewSchema = {
  ...
  "image": "https://amalegalsolutions.com/services/litigation-rajasthan.png",
...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://amalegalsolutions.com/services/litigation/rajasthan',
  },
  openGraph: {
    title: "Litigation Services in Rajasthan | High Court Lawyers Jaipur & Jodhpur",
    description: "Expert litigation services in Rajasthan. Representing clients in Rajasthan High Court and District Courts.",
    url: "https://amalegalsolutions.com/services/litigation/rajasthan",
    type: "website",
    images: [
      {
