...
const faqs = [
  {
    question: "What are the primary Intellectual Property Rights services available in Tripura?",
    answer: "Tripura offers a wide array of IPR services including Trademark Registration for brand identity, Patent Filing for inventions, Copyright Registration for creative works, and Geographical Indication (GI) registration for unique local products like the Queen Pineapple and Risa textile."
  },
  {
    question: "How can I register a Trademark in Tripura?",
    answer: "Trademark registration in Tripura is a centralized online process governed by the Trade Marks Registry. Applicants can file Form TM-A through the IP India portal. The process involves a trademark search, application filing, examination, and publication. AMA Legal Solutions provides end-to-end assistance, from conducting the initial search to handling objections and securing the registration certificate."
  },
  {
  ...
  },
  {
    ...
    answer: "Tripura has successfully registered several GI tags that highlight its agricultural and cultural wealth. The most notable ones include the Tripura Queen Pineapple, known for its unique aroma and sweetness, and the Risa textile, a traditional handwoven cloth. Recently, Matabari Pera (a sweet offering) and Pachra (textile) have also received GI status."
  },
  {
    question: "Does the Tripura government provide any support for IPR?",
    answer: "Yes, the Tripura government, in alignment with the National IPR Policy, encourages innovation. There are initiatives to support startups and MSMEs, including potential reimbursements for patent filing fees. The Tripura Agar Wood Policy also aims to promote and protect the local agarwood industry through IPR."
  },
  {
    question: "How long does it take to get a Trademark registered in Tripura?",
  ...
  {
    question: "Do I need a lawyer for IPR registration in Tripura?",
  ...
  return (
    <>
      ...
      <section id="faqs" className="scroll-mt-32">
        <h2 className="text-3xl font-bold text-gray-900 mb-8">Frequently Asked Questions (Tripura IPR)</h2>
