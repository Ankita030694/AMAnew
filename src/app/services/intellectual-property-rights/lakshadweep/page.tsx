...
export const metadata = {
  title: "Intellectual Property Rights Services in Lakshadweep",
  description:
    "Expert IPR services in Lakshadweep. We assist with Trademark Registration, Patent Filing, Copyright Protection, and GI Tags. Secure your intellectual.",
  alternates: {
    canonical: 'https://www.amalegalsolutions.com/services/intellectual-property-rights/lakshadweep',
  },
  openGraph: {
    title: "Intellectual Property Rights Services in Lakshadweep",
    description: "Expert IPR services in Lakshadweep. We assist with Trademark Registration, Patent Filing, Copyright Protection, and GI Tags. Secure your intellectual.",
