...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://amalegalsolutions.com/services/drafting/${slug}`,
    },
    openGraph: {
      title: content.title,
      description: content.description,
      url: `https://amalegalsolutions.com/services/drafting/${slug}`,
...
function generateWebPageSchema(content: any) {
  return {
    ...
    "name": content.title,
    "description": content.description,
    "url": `https://amalegalsolutions.com/services/drafting/${content.slug}`,
    "mainEntity": {
      "@type": "FAQPage",
...
export default function DraftingSlugPage({ params }: { params: { slug: string } }) {
  const slug = params.slug;
  const content = stateContent[slug as keyof typeof stateContent] || unionTerritoryContent[slug as keyof typeof unionTerritoryContent];
