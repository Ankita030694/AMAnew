            ...
            <div className="min-w-0">
               ...
               <div className="max-w-4xl mx-auto bg-white p-4 md:p-10 rounded-[40px] shadow-sm space-y-10 md:space-y-16">
                  ...
                  <section id="cibil-recovery" className="space-y-10 scroll-mt-32">
                    ...
                    <p className="text-sm md:text-lg text-gray-700 leading-relaxed text-gray-700">
                    ...
                    <h3 className="text-xl md:text-3xl font-black text-gray-900 text-gray-900">Loan Settlement for NRIs and Overseas Borrowers</h3>
                    <p className="text-sm md:text-lg text-gray-700 leading-relaxed text-gray-700">
                    ...
                    <h3 className="text-xl md:text-3xl font-black text-gray-900 text-gray-900">Cyber-Law Protections Against Digital Lending Apps</h3>
                    <p className="text-sm md:text-lg text-gray-700 leading-relaxed text-gray-700">
