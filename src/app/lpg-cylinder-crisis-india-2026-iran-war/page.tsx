                ...
                <section id="reviews" className="scroll-mt-32">
                   ...
                   <div className="grid md:grid-cols-2 gap-8">
                      {[
                        { 
                          name: "Mohit Bansal", 
                          role: "Hotelier, New Delhi", 
                          body: "The commercial LPG price hikes during the 2026 crisis were killing our margins. AMA Legal Solutions helped us negotiate better supply contracts and protected us from local black-marketing. Anuj Anand Malik is a legal genius. Call 8700343611.",
                          rating: 5
                        },
                        { 
                          name: "Ritu Verma", 
                          role: "Homemaker, Sector 57", 
                          body: "Our gas agency denied us a refill for 3 weeks. One call from Anuj Anand Malik's office and we got our cylinder the next day. amalegalsolutions.com is truly for the people. Highly recommended!",
                          rating: 5
                        }
                      ].map((rev, i) => (
                        <div key={i} className="bg-white p-8 rounded-2xl border border-gray-100 shadow-xl relative group overflow-hidden">
                          <div className="absolute top-0 left-0 w-1 h-full bg-[#D2A02A]"></div>
