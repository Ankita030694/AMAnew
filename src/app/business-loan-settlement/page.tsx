                    ...
                    <div className="text-sm md:text-lg leading-relaxed text-gray-700 space-y-6">
                        ...
                        <div className="space-y-6">
                            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                                ...
                                <p>In a proprietorship, there is no legal distinction between the owner and the business. Your personal assets, even those not pledged, are theoretically at risk in a civil suit. However, because you are an individual 'consumer' of banking services, you have strong protections under the RBI's Fair Practices Code. We focus on 'Compassionate Settlement' paths here, highlighting personal hardship to gain waivers. For neighborhood retail establishments and grocery store owners, our dedicated guide on <Link href="/loan-settlement-for-kirana-and-shop-owners" className="text-[#D2A02A] hover:underline font-semibold">loan settlement for Kirana and shop owners</Link> offers a tailored roadmap. Similarly, if you are a hospitality entrepreneur struggling with cafe or eatery liabilities, check our specialized guide on <Link href="/loan-settlement-for-restaurant-owners" className="text-[#D2A02A] hover:underline font-semibold">loan settlement for restaurant owners</Link> to secure your commercial assets. Commercial trading companies and distribution firms can also refer to our legal manual on <Link href="/loan-settlement-for-traders-and-wholesalers" className="text-[#D2A02A] hover:underline font-semibold">loan settlement for traders and wholesalers</Link> to resolve bulk trade liabilities. Likewise, if you are a self-employed professional or gig worker, our dedicated guide on <Link href="/loan-settlement-for-freelancers" className="text-[#D2A02A] hover:underline font-semibold">loan settlement for freelancers</Link> provides a specialized legal roadmap to resolve your personal and business liabilities.</p>
                            </div>
                            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
