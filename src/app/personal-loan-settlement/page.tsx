                ...
                <section id="eligibility" className="scroll-mt-32">
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                      ...
                      <p className="text-gray-600">For self employed borrowers, producing audited financial statements showing consecutive quarters of massive net loss provides banks with undeniable proof of business insolvency.</p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
