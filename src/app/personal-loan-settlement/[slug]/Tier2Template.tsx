...
export default function Tier2Template({ bankName, slug, uniqueBankStrategy }: { bankName: string, slug: string, uniqueBankStrategy?: string }) {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
      "@type": "Question",
      "name": `How do I correctly initiate a ${bankName} personal loan settlement process?`,
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": `No, ${bankName} is not legally required to accept any settlement offer. They evaluate proposals based on strict internal algorithmic risk parameters. However, because personal loan debt is completely unsecured, they are heavily financially motivated to settle rather than engage in prolonged, expensive civil litigation.`
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": `Can ${bankName} initiate criminal proceedings against me for defaulting on my personal loan?`,
      "acceptedAnswer": {
        "@type": "Answer",
        "text": `No. Defaulting on an unsecured ${bankName} personal loan is exclusively a civil legal matter, not a criminal offense. They cannot register an FIR or facilitate your arrest for inability to pay, provided the card was not obtained using fraudulent documentation.`
      }
    },
    {
      "@type": "Question",
  ...
  const reviewSchema = {
    ...
    "review": [
      ...
      "reviewBody": `After a business loss, my ${bankName} personal loan debt skyrocketed due to insane late fees. AMA Legal Solutions intervened, completely stopped the daily harassment from their boutique agencies, and negotiated a massive settlement focused only on the principal. Truly a lifesaver.`
    },
    {
      "@type": "Review",
      "author": {
            ...
            <main className="min-w-0">
              ...
              <article className="bg-white p-3 md:p-12 rounded-2xl shadow-sm space-y-6 md:space-y-12">
                ...
                <section id="legal-framework" className="scroll-mt-32">
                  ...
                  <p className="text-sm md:text-lg leading-relaxed mb-6 text-gray-700">{`A critical, highly effective legal concept in debt negotiation with ${bankName} is the statute of limitations. In India, for unsecured debts such as personal loans, this limitation period is generally capped at three years from the exact date of your last payment. If ${bankName} fails to file formal, legitimate civil suits within this precise window, the debt becomes legally time-barred, drastically shifting the settlement leverage in your favor.`}</p>
                ...
                <section id="post-settlement" className="scroll-mt-32">
                  ...
                  <p className="text-sm md:text-lg leading-relaxed mb-6 text-gray-700">{`Reaching a verbal consensus with a ${bankName} executive is only the preliminary phase. The finalization of a personal loan settlement is a strictly formal, legally binding procedure that demands meticulous attention to documentation to guarantee ${bankName} cannot legally pursue you for the waived balance at a later date.`}</p>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="border-b border-gray-200 pb-6 last:border-0 hover:bg-gray-50 p-4 transition-colors rounded-lg">
                        <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-start">
                          ...
                          {`How do I correctly initiate a ${bankName} personal loan settlement process?`}
                        </h3>
                      ...
                      <div className="border-b border-gray-200 pb-6 last:border-0 hover:bg-gray-50 p-4 transition-colors rounded-lg">
                        <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-start">
                          <span className="text-[#D2A02A] mr-3 mt-1 shadow-sm">Q.</span>
                          {`Can ${bankName} initiate criminal proceedings against me for defaulting on my personal loan?`}
                        </h3>
                        <p className="text-gray-700 leading-relaxed pl-8">
                          {`No. Defaulting on an unsecured ${bankName} personal loan is exclusively a civil legal matter, not a criminal offense. They cannot register an FIR or facilitate your arrest for inability to pay, provided the card was not obtained using fraudulent documentation.`}
                        </p>
                      </div>
