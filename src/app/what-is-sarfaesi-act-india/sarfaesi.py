...
page_slug = "what-is-sarfaesi-act-india"
primary_keyword = "best loan settlement india"
author_image = "/anujbhiya.png"

# Content blocks
lead_hook = """According to recent RBI data, Indian banks invoke the SARFAESI Act to recover thousands of crores in bad loans every year, frequently targeting the residential properties of ordinary families facing financial distress. If you have just received a Section 13(2) demand notice from your lender, you legally have exactly 60 days to act before they can initiate the process to take symbolic or physical possession of your home."""
              ...
              <article>
                ...
                <div className="bg-white p-3 md:p-12 rounded-2xl shadow-sm space-y-6 md:space-y-12">
                  ...
                  <section id="legal-process-map" className="scroll-mt-32">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">The Section 13(2) Notice: Your 60-Day Warning</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">The Section 13(4) Notice: Symbolic vs. Physical Possession</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">The Role of the Chief Metropolitan Magistrate (CMM) or DM</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                  ...
                  <section id="myth-vs-fact" className="scroll-mt-32">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Myth: The Bank Can Evict You Overnight Without Warning</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Fact: Borrowers Have Strict Legal Remedies Under Section 17</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                  ...
                  <section id="step-checklist" className="scroll-mt-32">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Step 1: Analyze the Notice and Verify the NPA Classification</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Step 2: Submit a Formal Representation Under Section 13(3A)</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Step 3: Initiate Loan Settlement Discussions Before Auction</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                  ...
                  <section id="stop-auction" className="scroll-mt-32">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Understanding Asset Reconstruction Companies (ARCs)</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                  ...
                  <section id="ama-protection" className="scroll-mt-32">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Expert Legal Defense Against Aggressive Bank Recovery</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Negotiating Strategic Settlements to Resolve the Debt</h3>
                    <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
...
dir_path = "/Users/amalegalsolutions/Desktop/AMAWORK/AMA/ama/src/app/" + page_slug
