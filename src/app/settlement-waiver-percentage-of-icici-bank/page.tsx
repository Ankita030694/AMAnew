            ...
            <article className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm space-y-8 text-lg leading-relaxed text-gray-700">
                ...
                <section id="hardship-factors-that-push-icici-to-increase-the-discount" className="scroll-mt-32 border-t pt-8">
                  ...
                  <p className="mb-4">
                    Understanding the willful defaulter consequences is crucial here. If the bank believes you are faking the hardship, they will classify you as a willful defaulter, ending all settlement negotiations and initiating severe legal actions, including publishing your name and photograph in national newspapers. Absolute transparency and honesty regarding your financial ruin are mandatory for a successful settlement.
                  </p>
                </section>
