    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative bg-[#FFFCF5] rounded-2xl p-8 max-w-lg w-full shadow-2xl scale-100 animate-in zoom-in-95 duration-200 border border-[#D29E0D]/20">
        ...
        <div className="flex flex-col items-center text-center">
            <div className="w-16 h-16 bg-[#D29E0D] rounded-full flex items-center justify-center mb-6">
                 <img src="/newAssets/logo/ama_box.svg" className="w-8 h-8 object-contain" alt="AMA Logo" />
            </div>
            ...
            <div className="flex justify-center gap-4">
                <Link href="https://play.google.com/store/apps/details?id=com.ama.ama_legal_solutions" target="_blank" className="hover:opacity-80 transition-opacity">
                    <Image src="/newAssets/appstore.svg" alt="App Store" width={140} height={42} className="w-[140px] h-auto" />
                </Link>
                <Link href="https://apps.apple.com/in/app/ama-legal-solutions/id6755156186" target="_blank" className="hover:opacity-80 transition-opacity">
                    <Image src="/newAssets/playstore.svg" alt="Google Play" width={140} height={42} className="w-[140px] h-auto" />
                </Link>
            </div>
        </div>
      </div>
...
const QuestionCard = ({ question, isOpen, onToggle, onRestrictedAction }: { question: Question, isOpen: boolean, onToggle: (id: string) => void, onRestrictedAction: () => void }) => {
  ...
  const hasOfficialAnswer = !!question.answer || !!question.answered_by;
      ...
      {question.answer && (
         <div className="mt-5 relative overflow-hidden rounded-xl border border-[#D29E0D]/30 bg-gradient-to-br from-[#FFFCF5] to-[#F9F5EC] p-6 shadow-sm">
             ...
             <div className="absolute top-0 right-0 p-4 opacity-5 pointer-events-none">
                <img src="/newAssets/logo/ama_box.svg" className="w-24 h-24 rotate-12" alt="" />
             </div>
             
             <div className="relative z-10 flex gap-4">
                 <div className="flex-shrink-0">
                   <div className="w-10 h-10 rounded-full bg-[#30261C] flex items-center justify-center shadow-md border-2 border-[#D29E0D]/20">
                     <img 
                        ...
                        <div key={comment.id} className="group">
                             <div className="flex items-start gap-4">
                                {comment.userRole === 'advocate' || comment.userRole === 'admin' ? (
                                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#30261C] flex items-center justify-center border border-[#D29E0D]/30">
                                         <img 
                                            src="/newAssets/logo/ama_box.svg" 
                                            alt="AMA Expert" 
                                            className="w-5 h-5 object-contain"
