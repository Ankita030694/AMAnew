...
export const metadata = {
  alternates: {
    canonical: 'https://www.amalegalsolutions.com/consumer-complaint-notice',
  },
  title: "Consumer Complaint Notice: Process & Format India",
  description:
    "Send a consumer complaint notice in India. Learn the legal procedure, notice format, and court fees under Consumer Protection Act 2019 with expert lawyers.",
