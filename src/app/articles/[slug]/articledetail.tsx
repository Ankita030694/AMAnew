...
// Define interfaces to match page.tsx
...
const ArticleDetail = memo(function ArticleDetail({ article, faqs, reviews, relatedArticles }: ArticleDetailProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F5F2EB] text-gray-800">
      {/* Hero Image Section */}
      <div className="w-full h-[300px] md:h-[400px] relative bg-[#1a202c]">
        {article.image && (
          <div 
      ...
      <div className="container mx-auto px-4 max-w-[1600px] py-8">
        ...
        <div className="flex flex-col items-center text-center mb-12 max-w-4xl mx-auto">
          ...
          <div className="flex items-center space-x-4 text-sm md:text-base text-gray-500">
            ...
            <span>•</span>
            <span className="font-medium text-[#D2A02A]">{article.author || 'AMA Legal Solutions'}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-8 items-start">
          ...
          <div className="min-w-0">
            ...
            <div className="bg-white p-6 md:p-12 rounded-2xl shadow-sm space-y-12">
              ...
              {/* Tiptap Styles (Copied from BlogDetail for consistency) */}
              <style jsx global>{`
                ...
                <section className="border-t border-gray-200 pt-12">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
                    {relatedArticles.map((relArticle) => (
                      <Link key={relArticle.id} href={`/articles/${relArticle.slug}`} className="group">
                        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow h-full flex flex-col">
                          <div className="relative h-48 overflow-hidden">
                            <img 
                              src={relArticle.image || '/placeholder-blog.jpg'} 
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  ...
                  <div className="flex items-center mb-4">
                    <div className="w-16 h-16 rounded-full overflow-hidden mr-4">
                      <img 
                        src={authorBios[article.author as keyof typeof authorBios]?.image || "/default-author.svg"}
                        alt={article.author}
                    ...
                    <div>
                      ...
                      <Link 
                        href={article.author === "Anuj Anand Malik" ? "/author/anuj-anand-malik" : 
                              article.author === "Shrey Arora" ? "/author/shrey-arora" : "/about"}
                  ...
                  <p className="text-sm text-gray-600 mb-4 line-clamp-4">
                    {authorBios[article.author as keyof typeof authorBios]?.description}
                  </p>
                  <a 
                    href={authorBios[article.author as keyof typeof authorBios]?.linkedInUrl}
                    target="_blank"
