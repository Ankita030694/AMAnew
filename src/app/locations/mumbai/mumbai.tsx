      ...
      <div className="relative h-[50vh] min-h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl px-4 z-10 flex flex-col items-center mt-12 md:mt-20">
            ...
            >
              <h1 className="text-4xl font-bold mb-4 md:mb-8 text-shadow-lg relative text-center">
                ...
                <span className="inline-block relative">
                  &nbsp; Trusted Law Firm in Mumbai for Legal Solutions
                  <motion.div 
            ...
            >
              A reputed law firm based in Mumbai, we offer expert legal consultation and financial dispute resolution. Our skilled team of lawyers delivers strategic legal support to individuals, startups, and businesses across Mumbai.
