      ...
      <div className="relative h-[50vh] min-h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl px-4 z-10 flex flex-col items-center mt-12 md:mt-20">
            ...
            >
              A trusted law firm based in Bengaluru provides corporate law, contract drafting, regulatory compliance, and startup legal support. We offer practical legal solutions for individuals, entrepreneurs, and growing businesses across the city. 
