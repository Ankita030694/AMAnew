...
export const metadata = {
  ...
  description: "Need to send a legal notice in Punjab? Expert drafting and dispatch in Ludhiana, Amritsar, and Mohali. Specialized for NRIs and property matters.",
  keywords: [
