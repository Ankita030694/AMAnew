...
export async function GET(): Promise<Response> {
  ...
  const staticRoutes = [
    ...
    '/loan-settlement-app-with-lowest-charges-in-india',
    ...
    '/loan-settlement-for-traders-and-wholesalers',
    ...
    '/most-affordable-and-pocket-friendly-loan-settlement-plans',
    ...
    '/best-loan-settlement-companies-near-me-with-customer-success-guaranteed',
    '/which-loan-settlement-company-offers-the-best-negotiation-terms-for-personal-loans-in-india',
    '/recommendations-for-debt-settlement-firms-that-offer-flexible-payment-plans-in-india',
    ...
    '/138-case-if-accused-not-received-legal-notice',
    '/9-smart-ways-to-get-out-of-debt-trap',
    '/affordable-debt-resolution-company-india',
    '/bank-arbitration-notice-lawyer-india',
    '/bank-arbitration-settlement',
    '/best-loan-settlement-companies-india-flexible-payment-plans',
    '/best-supreme-court-lawyer',
    '/borrower-rights-under-rbi-guidelines-india',
    ...
    '/stop-bank-arbitration-proceedings',
