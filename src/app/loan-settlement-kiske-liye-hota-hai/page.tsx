            ...
            <main className="min-w-0">
              ...
              <article className="bg-white p-3 md:p-12 rounded-2xl shadow-sm space-y-6 md:space-y-12">
                ...
                <section id="exact-timeline" className="scroll-mt-32">
                  ...
                  <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
                    However, waiting too long also carries immense risks. If the account remains unsettled for an extended period, the bank might initiate formal legal proceedings, such as filing a civil suit or initiating arbitration. Once litigation commences, securing a favorable settlement becomes much harder, as the bank has already incurred legal costs. Furthermore, understanding the RBI guidelines for loan recovery is essential to protect yourself from harassment during this stressful period.
                  </p>
                  <p className="text-sm md:text-lg leading-relaxed mb-4 text-gray-700">
