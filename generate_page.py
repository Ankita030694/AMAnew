...
def create_page():
  ...
  "itemListElement": [
    ...
    lead_hook = "In 2023, data from Indian consumer legal forums indicated that nearly 40% of contested debt settlement negotiations stalled simply because borrowers failed to provide their legal counsel with complete communication logs and sanction letters. When you hire a law firm to negotiate a loan settlement, handing over the exact, verifiable documentation ranging from original loan agreements to proof of financial hardship is the only way to compel a bank to reduce your outstanding principal."
        ...
        <div className="container mx-auto px-4 max-w-[1600px] py-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 items-start">
            ...
            <article className="bg-white p-4 md:p-12 rounded-2xl shadow-sm space-y-8">
              ...
              <section id="why-documentation-dictates-outcome">
                <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Why Legal Documentation Dictates Your Loan Settlement Outcome</h2>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                  {all_content[12]}
                </p>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
              ...
              <section id="initial-assessment">
                <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Initial Assessment: Documents Your Lawyer Needs First</h2>
                
                <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">The Original Loan Agreement and Sanction Letter</h3>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                  {all_content[2]}
                </p>

                <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Complete Statement of Account</h3>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                  {all_content[3]}
                </p>

                <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Identifying All Default and Recall Notices</h3>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                  {all_content[4]}
                </p>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
              ...
              <section id="proof-of-hardship">
                <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Proof of Financial Hardship: The Core Negotiation Leverage</h2>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                  {all_content[6]}
                </p>
                
                <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Medical and Employment Records</h3>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                  {all_content[7]}
                </p>

                <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 mt-6">Certified Bank Statements and Tax Returns</h3>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                  {all_content[8]}
                </p>
              </section>

              <section id="legal-process-map" className="my-10 p-6 border-2 border-gray-100 rounded-xl shadow-sm">
                <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">The Legal Process Map: From Document Submission to Final NOC</h2>
              ...
              <section id="common-pitfalls">
                <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Common Pitfalls: Documents That Can Sabotage Your Settlement</h2>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                  {all_content[9]}
                </p>
                <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
              ...
              <section id="step-checklist" className="my-10">
                <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Step Checklist for Assembling Your Settlement File</h2>
              ...
              <section id="faqs">
                <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Frequently Asked Questions About Legal Documentation</h2>
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-900">What documents are needed for settlement?</h4>
                    <p className="text-gray-700 mt-2">You need the loan agreement, sanction letter, account statements, recall notices, medical records, and tax returns.</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-900">Why do lawyers need my bank statements?</h4>
                    <p className="text-gray-700 mt-2">Bank statements prove your financial hardship and establish your inability to repay the full loan amount.</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-900">Can I settle without the original agreement?</h4>
                    <p className="text-gray-700 mt-2">While difficult, lawyers can sometimes use alternate proofs like detailed bank statements and correspondence logs.</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-900">Are medical records mandatory for waiver?</h4>
                    <p className="text-gray-700 mt-2">They are not mandatory but highly recommended if your financial crisis stems from unexpected medical emergencies.</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-900">How long does document verification take?</h4>
                    <p className="text-gray-700 mt-2">Law firms typically take two to four days to verify all submitted documents before drafting the proposal.</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-900">Does a legal notice replace the loan agreement?</h4>
                    <p className="text-gray-700 mt-2">No, a legal notice highlights the default but the original agreement is required to verify the exact terms.</p>
                  </div>
                </div>
              </section>

              <section id="reviews">
                <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-6">Client Success Reviews</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div className="flex items-center mb-2">
                      <div className="text-yellow-400">★★★★★</div>
                    </div>
                    <p className="text-gray-700 text-sm mb-4">"They explained exactly which documents I needed. The checklist was perfect and saved my case."</p>
                    <p className="text-gray-900 font-bold text-sm">- Karan Mehta</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div className="flex items-center mb-2">
                      <div className="text-yellow-400">★★★★★</div>
                    </div>
                    <p className="text-gray-700 text-sm mb-4">"Providing my medical records and bank statements as advised helped reduce my loan by fifty percent."</p>
                    <p className="text-gray-900 font-bold text-sm">- Sonia Varma</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div className="flex items-center mb-2">
                      <div className="text-yellow-400">★★★★☆</div>
                    </div>
                    <p className="text-gray-700 text-sm mb-4">"Professional advice. Finding all old notices was hard but the legal team guided me thoroughly."</p>
                    <p className="text-gray-900 font-bold text-sm">- Rajiv Nanda</p>
                  </div>
                </div>
              </section>
...
"""
    ...
    with open("src/app/documents-required-for-loan-settlement-through-law-firm/page.tsx", "w", encoding="utf-8") as f:
