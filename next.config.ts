...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/services/loan-settlement/karnataka-bank', destination: '/services/loan-settlement', permanent: true },
      { source: '/blog/rbi-guidelines-loan-harassment', destination: '/blog/understanding-rbi-guidelines-recovery-agents', permanent: true },
      { source: '/updates', destination: '/blog', permanent: true },
      { source: '/legal-notice-for-loan-default', destination: '/how-to-reply-to-bank-legal-notice-for-personal-loan-default', permanent: true },
      { source: '/one-time-settlement-guide', destination: '/one-time-settlement-scheme-for-personal-loan-2026', permanent: true },
      { source: '/understanding-cibil-score-after-settlement', destination: '/what-is-cibil-score', permanent: true },
      { source: '/how-to-stop-recovery-agent-harassment', destination: '/how-to-stop-bank-recovery-agents-harassment-legally-in-india', permanent: true },
      { source: '/personal-loan-settlement-process-india', destination: '/personal-loan-settlement', permanent: true },
      { source: '/how-to-send-legal-notice', destination: '/send-legal-notice', permanent: true },
      { source: '/dpdp-act-guide', destination: '/services/cyber', permanent: true },
